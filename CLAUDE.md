...
- OneNet、COS 和真机具备后续联调条件；
- MCU 固件由其他负责人实施，可以按 UART Registry 配合；
- F-10 软件生成物和候选 OneNet 物模型已完成并通过本地校验，仍等待 MCU C、真实
  Python 3.11 和跨端联调验收，不能称为最终冻结；
