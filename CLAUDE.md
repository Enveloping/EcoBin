...
- 当前实施授权按任务范围管理：H-01、H-02、F-01、F-02、F-03、F-04、F-05、F-06、F-07、F-08、F-09、V-01 已授权并完成，
  F-10 软件已完成，F-11 已授权且处于 `in-progress`；
  H-02 已完成本地开发演练和服务器阶段 0～3；阶段 4、seed、旧库操作和真实入口切换
  仍须分别获得明确授权；V-02 为 `ready` 但未获实施授权；
