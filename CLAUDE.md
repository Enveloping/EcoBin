...
- 当前实施授权按任务范围管理：H-01、H-02、F-01、F-02、F-03、F-04、F-05、F-06、F-07、F-08、F-09、F-10、V-01 已授权并完成，
  F-11 已授权且处于 `in-progress`；V-02 software 已完成但任务级仍等待真实微信
  integration/acceptance。H-02 阶段 4、正式 seed、旧库操作和真实入口切换仍须分别
  获得明确授权；用户说“讨论、计划、设计”时保持文档级工作；
