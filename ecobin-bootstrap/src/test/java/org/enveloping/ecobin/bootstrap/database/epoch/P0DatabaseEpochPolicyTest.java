...
class P0DatabaseEpochPolicyTest {
    ...
    @Test
    void acceptsTheExactV1MarkerAndCompleteV13Epoch() {
        ...
        assertEquals(13, verification.minimumVersion());
    ...
    private static List<P0DatabaseEpochPolicy.Migration> validMigrations() {
        ...
        migrations.add(migration(
                ...
                229072802,
                true));
        for (int version = 2; version <= 13; version++) {
            migrations.add(migration(
                    version,
