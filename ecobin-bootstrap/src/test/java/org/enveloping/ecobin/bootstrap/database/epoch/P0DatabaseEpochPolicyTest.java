...
class P0DatabaseEpochPolicyTest {
    ...
    @Test
    void acceptsTheExactV1MarkerAndCompleteV23Epoch() {
        ...
        assertEquals(23, verification.minimumVersion());
    ...
    private static List<P0DatabaseEpochPolicy.Migration> validMigrations() {
        ...
        migrations.add(migration(
                ...
                229072802,
                true));
        for (int version = 2; version <= 23; version++) {
            migrations.add(migration(
                    version,
