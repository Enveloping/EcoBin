...
class P0DatabaseEpochPolicyTest {
    ...
    @Test
    void acceptsTheExactV1MarkerAndCompleteV41Epoch() {
        ...
        assertEquals(41, verification.minimumVersion());
    ...
    private static List<P0DatabaseEpochPolicy.Migration> validMigrations() {
        ...
        migrations.add(migration(
                ...
                229072802,
                true));
        for (int version = 2; version <= 41; version++) {
            migrations.add(migration(
                    version,
