...
class P0DatabaseEpochPolicyTest {
    ...
    @Test
    void acceptsTheExactV1MarkerAndCompleteV56Epoch() {
        ...
        assertEquals(56, verification.minimumVersion());
    ...
    private static List<P0DatabaseEpochPolicy.Migration> validMigrations() {
        ...
        migrations.add(migration(
                ...
                229072802,
                true));
        for (int version = 2; version <= 56; version++) {
            migrations.add(migration(
                    version,
