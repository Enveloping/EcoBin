...
class P0DatabaseEpochPolicyTest {
    ...
    @Test
    void acceptsTheExactV1MarkerAndCompleteV45Epoch() {
        ...
        assertEquals(45, verification.minimumVersion());
    ...
    private static List<P0DatabaseEpochPolicy.Migration> validMigrations() {
        ...
        migrations.add(migration(
                ...
                229072802,
                true));
        for (int version = 2; version <= 45; version++) {
            migrations.add(migration(
                    version,
