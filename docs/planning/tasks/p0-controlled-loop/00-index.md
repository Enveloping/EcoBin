...
> F-03、F-04、F-05，并确认 F-10 软件阶段完成和 F-11 软件实施授权；
> 其他任务仍须逐项获得授权。
...
| 实施授权 | **部分授权：H-01、F-01、F-02、F-03、F-04、F-05 已授权并完成；F-10 通用三语言证据已通过但 MCU 实际工具链/HIL 未收口；F-11 已授权并实施中；其他任务未授权** |
| 当前状态数 | `done` 6、`ready` 2、`in-progress` 1、`blocked` 20 |
