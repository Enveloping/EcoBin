...
> F-03、F-04、F-05、F-06、F-07，并确认 F-10 软件阶段完成和 F-11 软件实施授权；
> 其他任务仍须逐项获得授权。
...
| 实施授权 | **部分授权：H-01、F-01、F-02、F-03、F-04、F-05、F-06、F-07 已授权并完成；F-10 通用三语言证据已通过但 MCU 实际工具链/HIL 未收口；F-11 实施中；其他任务未授权** |
| 当前状态数 | `done` 8、`ready` 2、`in-progress` 1、`blocked` 18 |
...
- 2026-07-26：F-07 根据评审移除生产 JAR 中的 Flyway 运行库/全部迁移脚本，并修复
  servlet context path 对 Fake 入站闩锁的绕过；Java 21 全量 103 项测试和 MySQL
  8.4.10 生产 JAR 矩阵通过。项目负责人确认更新文档、提交并合入
  `database-refactor`，F-07 转为 `done`。当前共 `done` 8、`ready` 2、
  `in-progress` 1、`blocked` 18。
