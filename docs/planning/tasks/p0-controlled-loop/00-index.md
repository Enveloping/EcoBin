...
> F-11 已获软件实施授权并处于 `in-progress`；H-02 已通过本地 MySQL 8.4
...
| 实施授权 | **部分授权：H-01、H-02、F-01、F-02、F-03、F-04、F-05、F-06、F-07、F-08、F-09 已授权并完成；F-10 通用三语言证据已通过但 MCU 实际工具链/HIL 未收口；F-11 实施中；H-02 当前试验期 `.ecobin` 凭证保管例外已接受；阶段 4 及其他任务未授权** |
| 当前状态数 | `done` 11、`ready` 0、`in-progress` 1、`blocked` 17 |
...
- 2026-07-26：项目负责人 `enveloping` 明确授权 H-02 并担任人工操作人，选择独立
  MySQL 8.4 容器与独立数据卷供应目标环境；H-02 转为 `in-progress`。当前共
  `done` 10、`ready` 0、`in-progress` 2、`blocked` 17。
- 2026-07-26：H-02 完成独立 MySQL 8.4.10 容器/数据卷、V1～V10、五类身份、
  ...
  `in-progress`。当前共 `done` 10、`ready` 0、`in-progress` 2、`blocked` 17。
- 2026-07-27：项目负责人授权 H-02 阶段 3；服务器独立目标 MySQL 8.4.10、V1～V10、
  ...
  确认，H-02 保持 `in-progress`。当前共 `done` 10、`ready` 0、
  `in-progress` 2、`blocked` 17。
- 2026-07-27：项目负责人重新裁定当前前期受控试验的凭证保管门：操作机 ACL 受限
  ...
  转为 `done`。当前共 `done` 11、`ready` 0、`in-progress` 1、`blocked` 17；
