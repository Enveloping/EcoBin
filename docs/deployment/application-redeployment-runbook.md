...
> 2026-09-14 13:51 异常投递人工结束与设备报废拆分修正版已通过 V72 独立兼容包部署，当前发布 `20260914054917-646ab11784ae`；现网仍为 V72 / 134 张业务表 / 72 条成功迁移。原绑定入口没有被使用并已下线；[部署及回退边界](../operations/abnormal-delivery-termination-separation-deployment-2026-09-14.md)。
