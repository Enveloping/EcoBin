...
> 2026-09-14 12:52 异常投递人工结束并报废已通过 V72 独立兼容包部署，当前发布 `20260914044815-8d58b6862637`；现网仍为 V72 / 134 张业务表 / 72 条成功迁移。部署没有结束现网异常投递；[部署及回退边界](../operations/abnormal-delivery-retirement-deployment-2026-09-14.md)。
