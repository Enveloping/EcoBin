...
> 2026-09-16 设备管理界面与列表满溢汇总发布
> `20260916090730-99d26dc4338b` 已激活；生产库没有迁移，保持 V84 / 138 张领域表。后端与
> Web 健康、重启数为 0，运行时密钥探针、持久日志和公网入口均通过；
> [部署记录](../operations/device-web-refinement-deployment-2026-09-16.md)。

> 2026-09-16 后端与 Web 发布 `20260916025440-863bcc8cca74` 已激活，生产库为 V84 / 138 张
> 领域表 / 84 条成功迁移。负责人明确要求本次不创建数据库备份；迁移、结构账号复锁、应用
> 健康、v45 允许版本保留及远程业务程序下发关闭均已独立核对；
> [部署记录](../operations/backend-v84-deployment-2026-09-16.md)。
