...
若现有数据库已完整到 V30、V31、V32、V33、V34、V35、V36、V37、V38、V39、V40、V41、V42、V43、V44 或 V45、owner 已锁定，使用：
...
V36/V37/V38 为 93 张领域表、V39/V40/V41 为 95 张领域表、V42 为 96 张领域表，V43/V44/V45 为 98 张领域表，并且迁移历史精确停在
V30、V31、V32、V33、V34、V35、V36、V37、V38、V39、V40、V41、V42、V43、V44 或 V45。低于 V45 时会用一次性新密码
解锁 schema owner，只执行尚缺的前向迁移直到 V45，完成后立即重新锁定；V45 不解锁
owner、不重复迁移。
...
等持久化对象落到精确更新列。当前 grants 目录已按冻结状态机、不可变边界和 V45 DDL
补齐。
