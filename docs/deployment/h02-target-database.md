...
若现有数据库已完整到 V30、V31、V32、V33、V34、V35、V36、V37、V38、V39、V40、V41、V42、V43、V44、V45、V46、V47、V48、V49、V50 或 V51、owner 已锁定，使用：
...
V43/V44/V45 为 98 张领域表，V46/V47/V48/V49/V50/V51 为 99 张领域表，并且迁移历史精确停在
V30、V31、V32、V33、V34、V35、V36、V37、V38、V39、V40、V41、V42、V43、V44、V45、V46、V47、V48、V49、V50 或 V51。低于 V51 时会用一次性新密码
解锁 schema owner，只执行尚缺的前向迁移直到 V51，完成后立即重新锁定；V51 不解锁
owner、不重复迁移。
...
等持久化对象落到精确更新列。当前 grants 目录已按冻结状态机、不可变边界和 V51 DDL
补齐。
...
- 对 61 张 P/O 表只授予矩阵明确列出的列级 `UPDATE`。
...
目录版本 20 在版本 19 的厂家初始袋权限之上，新增
`dev_runtime_snapshot_policy` 的策略发布和批次进度列级更新权限；没有增加任何删除权限。
版本 19 补齐厂家初始袋自动皮重投影：运行账号只可更新
