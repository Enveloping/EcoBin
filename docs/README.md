...
> 当前增量：[S4发布清单与隔离包保管](../hardware/docs/review/simplified-release-custody-s4-2026-09-14.md)。当前业务包62文件/schema40/摘要f45f4370…，完整运行包73文件；后台包验证器已同步。24项隔离重开及92项发布相关检查通过，正常入口只使用rc.23 START。旧共享逐动作MCU测试夹具与真实RS485/换袋/断电HIL、Linux/ARM64安装、热点/固件管理和部署仍未完成，不能部署烧录。下方复杂恢复候选均为历史。
