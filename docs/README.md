...
9. [P0 受控闭环正式任务](planning/tasks/p0-controlled-loop/00-index.md)：29 项独立任务、状态、执行主体、依赖、工作量和验收证据；H-01、F-01、F-02、F-03、F-04、F-05、F-06、F-09 已完成，F-11 继续 `in-progress`，H-02 为 `ready` 但真实环境操作仍须授权；F-10 通用三语言黄金样本已通过但 MCU 实际工具链/HIL 未收口。
