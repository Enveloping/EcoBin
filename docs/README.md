...
9. [P0 受控闭环正式任务](planning/tasks/p0-controlled-loop/00-index.md)：29 项独立任务、状态、执行主体、依赖、工作量和验收证据；H-01、H-02、F-01、F-02、F-03、F-04、F-05、F-06、F-07、F-08、F-09、V-01 已完成，F-11 已完成配置命令软件纵切并继续 `in-progress`，V-02 为 `ready` 但尚未获得实施授权；H-02 已通过本地 MySQL 8.4.10 开发演练及服务器整改阶段 0～3 验收，当前试验期由项目负责人接受操作机 ACL 受限 `.ecobin` 保管长期凭证原件，加密密码库和异机密码库副本延期到下一版本；F-10 通用三语言黄金样本已通过但 MCU 实际工具链/HIL 未收口。
