...
9. [P0 受控闭环正式任务](planning/tasks/p0-controlled-loop/00-index.md)：29 项独立任务、状态、执行主体、依赖、工作量和验收证据；H-01、F-01、F-02、F-04 已完成，F-03/F-05/F-09 已 `ready` 但未授权，F-10 软件已完成并等待 MCU/联调验收。
