...
> 当前推进：[MCU与香橙派精简实施计划](../planning/mcu-edge-simplified-implementation-plan-2026-09-13.md)。用户已确认D12仅恢复新接单并允许进入计划实现；核心共识已收敛，有限基线18项通过。按新路线本地推进，不继续旧多代机械恢复，不整库回退；业务改接/整机验证尚未完成，部署烧录另行授权。下方暂停和候选进度保留为历史。
