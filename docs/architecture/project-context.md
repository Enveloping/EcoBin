...
> 2026-09-14 异常投递人工结束并报废：[实现与验证](../planning/abnormal-delivery-retirement-2026-09-14.md)已通过现网V72独立兼容包部署为`20260914044815-8d58b6862637`，生产代码提交`8d58b6862637`。平台管理员只能在投递结果未知、无订单与物理结果、无活动任务租约且OneNet已连续报告离线至少10分钟时，经现场断电和机构安全确认，将原会话、精确占用、资产报废及剩余任务取消作为一个事务处理；不产生订单或资金效果。部署没有操作现网异常投递；V73至V83硬件候选未进入生产。见[部署与回退记录](../operations/abnormal-delivery-retirement-deployment-2026-09-14.md)。
