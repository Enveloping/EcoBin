...
> [!IMPORTANT]
> 2026-07-26 已完成需求、P0 范围、业务模型、系统架构、数据库设计、接口设计和详细设计修订；投递改为一次 session 一单/设备本地继续，清运改为电磁阀解锁/人工关门确认。DD-004 与修订后的 PDD-001 已写回基线，29 项正式 Markdown 任务也已同步。H-01、H-02、F-01、F-02、F-03、F-04、F-05、F-06、F-07、F-08、F-09 已获授权并完成；F-08 的 Fake 可靠任务 tracer、MySQL 8.4 验收和两项 P1 复审均已收口；F-11 已获授权并完成配置命令软件纵切，继续处于 `in-progress`；H-02 已通过本地 MySQL 8.4.10 开发演练及服务器整改阶段 0～3 验收，项目负责人接受当前试验期以操作机 ACL 受限 `.ecobin` 保管长期凭证原件，并把加密密码库和异机密码库密文副本延期到下一版本加固，任务已转为 `done`。F-10 软件机器来源、MCU Registry checkpoint 和通用 Java/Python 3.11/C11 黄金样本已完成，仍缺 MCU 实际工具链与 HIL。其他任务仍须逐项授权，`ready` 只表示依赖允许领取。正式上游依次为
...
`in-progress`。当前共 `done` 11、`ready` 0、`in-progress` 1、`blocked` 17。
