...
> 当前推进：[MCU与香橙派精简实施计划](../planning/mcu-edge-simplified-implementation-plan-2026-09-13.md)。[S4发布清单与隔离包保管](../../hardware/docs/review/simplified-release-custody-s4-2026-09-14.md)已将业务包对齐为62文件/schema40/摘要f45f4370…，完整运行包73文件；后台验证器同步。三批现行业务测试已迁移到START自主/完整结果权威流程，并补上工作槽原许可核对；前两批扩大合并437项通过，第三批与直接消费者200项通过。旧业务内采样组、冻结历史动作账本/恢复关门测试、真实RS485/换袋/断电HIL、Linux/ARM64安装、热点/固件管理和部署仍未完，仍不是可部署版本。清运中断人工袋确认候选保持V81/138张领域表/运行权限目录42；OneNet2.3.0/UART rc.23，完整MCU ROM56436/RAM12008。下方旧候选为历史。
