...
@RestController
@RequestMapping("/api/v1/web/platform/device-configuration-policy")
public class PlatformDevicePolicyController {

    private final TargetDeviceApplication application;

    public PlatformDevicePolicyController(
    ...
    public ResponseEntity<TargetApiEnvelope<DevicePolicyView>> get(
        ...
        return ResponseEntity.ok()
                ...
                .body(ok(application.devicePolicy(true), request));
    }
    ...
    public ResponseEntity<TargetApiEnvelope<DevicePolicyView>> release(
        ...
        return ResponseEntity.accepted()
                ...
                .body(ok(application.releaseDevicePolicy(
                        true, operationUid, body), request));
    }
