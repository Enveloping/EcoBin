...
function Assert-ApplicationReady {
    ...
    for ($attempt = 0; $attempt -lt 60; $attempt++) {
        ...
        if ($Run.Process.HasExited) {
            ...
            throw "correct V84 application exited before readiness`n$diagnostic"
        }
        try {
    ...
    throw "correct V84 application did not become ready; " +
...
"@
    ...
    if ($historyCount -ne 84) {
        throw "correct target must contain 84 successful Flyway migrations"
    }
