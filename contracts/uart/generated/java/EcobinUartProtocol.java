...
public final class EcobinUartProtocol {
    public static final String REGISTRY_SHA256 = "1c8f97160b2b8a202e8a6298f1bbe554f9311a6962244f1786e16cf5a2101705";
    ...
    public static final int MESSAGE_DELIVERY_DOOR_STATE_CHANGED = 0x31;
    ...
    public static final int CONFIG_DEVICE_BLOCK_PAYLOAD_MIN_LENGTH = 159;
    public static final int CONFIG_DEVICE_BLOCK_PAYLOAD_MAX_LENGTH = 159;
    ...
    public static final int CONFIG_DEVICE_BLOCK_CLEAN_SOLENOID_PULSE_MS_OFFSET = 154;
    public static final int CONFIG_DEVICE_BLOCK_SMOKE_MONITORING_ENABLED_OFFSET = 158;
    public static final int CONFIG_PORT_BLOCK_PAYLOAD_MIN_LENGTH = 191;
    public static final int CONFIG_PORT_BLOCK_PAYLOAD_MAX_LENGTH = 191;
    ...
    public static final int CONFIG_PORT_BLOCK_FULLNESS_CONFIRMATION_WAIT_MS_OFFSET = 153;
    public static final int CONFIG_PORT_BLOCK_WEIGHT_STABLE_WINDOW_MS_OFFSET = 157;
    public static final int CONFIG_PORT_BLOCK_WEIGHT_MAXIMUM_FLUCTUATION_GRAMS_OFFSET = 161;
    public static final int CONFIG_PORT_BLOCK_WEIGHT_REQUIRED_SAMPLE_COUNT_OFFSET = 165;
    public static final int CONFIG_PORT_BLOCK_WEIGHT_MEASUREMENT_TIMEOUT_MS_OFFSET = 167;
    public static final int CONFIG_PORT_BLOCK_WEIGHT_MINIMUM_GRAMS_OFFSET = 171;
    public static final int CONFIG_PORT_BLOCK_WEIGHT_MAXIMUM_GRAMS_OFFSET = 175;
    public static final int CONFIG_PORT_BLOCK_CALIBRATION_VERSION_OFFSET = 179;
    public static final int CONFIG_PORT_BLOCK_INFRARED_SAMPLE_TIMEOUT_MS_OFFSET = 183;
    public static final int CONFIG_PORT_BLOCK_DELIVERY_DOOR_OPERATION_TIMEOUT_MS_OFFSET = 187;
    ...
    public static final int RESUME_CLEAN_OPERATION_PAYLOAD_MIN_LENGTH = 117;
    public static final int RESUME_CLEAN_OPERATION_PAYLOAD_MAX_LENGTH = 117;
    ...
    public static final int RESUME_CLEAN_OPERATION_CONFIG_VERSION_OFFSET = 69;
    public static final int RESUME_CLEAN_OPERATION_CONFIG_CONTENT_SHA256_OFFSET = 77;
    public static final int RESUME_CLEAN_OPERATION_START_EXECUTION_WINDOW_MS_OFFSET = 109;
    public static final int RESUME_CLEAN_OPERATION_OPERATION_WINDOW_MS_OFFSET = 113;
    ...
    public static final int WORK_PREOPEN_WEIGHT_READY_PAYLOAD_MIN_LENGTH = 95;
    public static final int WORK_PREOPEN_WEIGHT_READY_PAYLOAD_MAX_LENGTH = 95;
    ...
    public static final int WORK_PREOPEN_WEIGHT_READY_STABLE_WEIGHT_VALID_OFFSET = 72;
    public static final int WORK_PREOPEN_WEIGHT_READY_STABLE_WEIGHT_GRAMS_OFFSET = 73;
    public static final int WORK_PREOPEN_WEIGHT_READY_LAST_OBSERVED_WEIGHT_VALID_OFFSET = 77;
    public static final int WORK_PREOPEN_WEIGHT_READY_LAST_OBSERVED_WEIGHT_GRAMS_OFFSET = 78;
    public static final int WORK_PREOPEN_WEIGHT_READY_MEASUREMENT_ELAPSED_MS_OFFSET = 82;
    public static final int WORK_PREOPEN_WEIGHT_READY_SAMPLE_COUNT_OFFSET = 86;
    public static final int WORK_PREOPEN_WEIGHT_READY_CALIBRATION_VERSION_OFFSET = 88;
    public static final int WORK_PREOPEN_WEIGHT_READY_WEIGHT_SENSOR_HEALTH_OFFSET = 92;
    public static final int WORK_PREOPEN_WEIGHT_READY_FAULT_CODE_OFFSET = 93;
    public static final int DELIVERY_DOOR_STATE_CHANGED_PAYLOAD_MIN_LENGTH = 57;
    public static final int DELIVERY_DOOR_STATE_CHANGED_PAYLOAD_MAX_LENGTH = 57;
    public static final int DELIVERY_DOOR_STATE_CHANGED_MCU_BOOT_ID_OFFSET = 0;
    public static final int DELIVERY_DOOR_STATE_CHANGED_MCU_EVENT_SEQUENCE_OFFSET = 8;
    public static final int DELIVERY_DOOR_STATE_CHANGED_UPTIME_MS_OFFSET = 12;
    public static final int DELIVERY_DOOR_STATE_CHANGED_MCU_COMMAND_UID_OFFSET = 20;
    public static final int DELIVERY_DOOR_STATE_CHANGED_SESSION_UID_OFFSET = 36;
    public static final int DELIVERY_DOOR_STATE_CHANGED_PORT_NO_OFFSET = 52;
    public static final int DELIVERY_DOOR_STATE_CHANGED_ROUND_INDEX_OFFSET = 53;
    public static final int DELIVERY_DOOR_STATE_CHANGED_DOOR_STATE_OFFSET = 55;
    public static final int DELIVERY_DOOR_STATE_CHANGED_DOOR_HEALTH_OFFSET = 56;
    public static final int WORK_POSTCLOSE_WEIGHT_READY_PAYLOAD_MIN_LENGTH = 95;
    public static final int WORK_POSTCLOSE_WEIGHT_READY_PAYLOAD_MAX_LENGTH = 95;
    ...
    public static final int WORK_POSTCLOSE_WEIGHT_READY_STABLE_WEIGHT_VALID_OFFSET = 72;
    public static final int WORK_POSTCLOSE_WEIGHT_READY_STABLE_WEIGHT_GRAMS_OFFSET = 73;
    public static final int WORK_POSTCLOSE_WEIGHT_READY_LAST_OBSERVED_WEIGHT_VALID_OFFSET = 77;
    public static final int WORK_POSTCLOSE_WEIGHT_READY_LAST_OBSERVED_WEIGHT_GRAMS_OFFSET = 78;
    public static final int WORK_POSTCLOSE_WEIGHT_READY_MEASUREMENT_ELAPSED_MS_OFFSET = 82;
    public static final int WORK_POSTCLOSE_WEIGHT_READY_SAMPLE_COUNT_OFFSET = 86;
    public static final int WORK_POSTCLOSE_WEIGHT_READY_CALIBRATION_VERSION_OFFSET = 88;
    public static final int WORK_POSTCLOSE_WEIGHT_READY_WEIGHT_SENSOR_HEALTH_OFFSET = 92;
    public static final int WORK_POSTCLOSE_WEIGHT_READY_FAULT_CODE_OFFSET = 93;
    ...
    public static final int WORK_PREUNLOCK_WEIGHT_READY_PAYLOAD_MIN_LENGTH = 93;
    public static final int WORK_PREUNLOCK_WEIGHT_READY_PAYLOAD_MAX_LENGTH = 93;
    ...
    public static final int WORK_PREUNLOCK_WEIGHT_READY_STABLE_WEIGHT_VALID_OFFSET = 70;
    public static final int WORK_PREUNLOCK_WEIGHT_READY_STABLE_WEIGHT_GRAMS_OFFSET = 71;
    public static final int WORK_PREUNLOCK_WEIGHT_READY_LAST_OBSERVED_WEIGHT_VALID_OFFSET = 75;
    public static final int WORK_PREUNLOCK_WEIGHT_READY_LAST_OBSERVED_WEIGHT_GRAMS_OFFSET = 76;
    public static final int WORK_PREUNLOCK_WEIGHT_READY_MEASUREMENT_ELAPSED_MS_OFFSET = 80;
    public static final int WORK_PREUNLOCK_WEIGHT_READY_SAMPLE_COUNT_OFFSET = 84;
    public static final int WORK_PREUNLOCK_WEIGHT_READY_CALIBRATION_VERSION_OFFSET = 86;
    public static final int WORK_PREUNLOCK_WEIGHT_READY_WEIGHT_SENSOR_HEALTH_OFFSET = 90;
    public static final int WORK_PREUNLOCK_WEIGHT_READY_FAULT_CODE_OFFSET = 91;
    ...
    public static final int CLEAN_FINAL_WEIGHT_READY_PAYLOAD_MIN_LENGTH = 79;
    public static final int CLEAN_FINAL_WEIGHT_READY_PAYLOAD_MAX_LENGTH = 79;
    ...
    public static final int CLEAN_FINAL_WEIGHT_READY_STABLE_WEIGHT_VALID_OFFSET = 56;
    public static final int CLEAN_FINAL_WEIGHT_READY_STABLE_WEIGHT_GRAMS_OFFSET = 57;
    public static final int CLEAN_FINAL_WEIGHT_READY_LAST_OBSERVED_WEIGHT_VALID_OFFSET = 61;
    public static final int CLEAN_FINAL_WEIGHT_READY_LAST_OBSERVED_WEIGHT_GRAMS_OFFSET = 62;
    public static final int CLEAN_FINAL_WEIGHT_READY_MEASUREMENT_ELAPSED_MS_OFFSET = 66;
    public static final int CLEAN_FINAL_WEIGHT_READY_SAMPLE_COUNT_OFFSET = 70;
    public static final int CLEAN_FINAL_WEIGHT_READY_CALIBRATION_VERSION_OFFSET = 72;
    public static final int CLEAN_FINAL_WEIGHT_READY_WEIGHT_SENSOR_HEALTH_OFFSET = 76;
    public static final int CLEAN_FINAL_WEIGHT_READY_FAULT_CODE_OFFSET = 77;
    public static final int FULLNESS_SAMPLE_RESULT_PAYLOAD_MIN_LENGTH = 96;
    public static final int FULLNESS_SAMPLE_RESULT_PAYLOAD_MAX_LENGTH = 96;
    ...
    public static final int FULLNESS_SAMPLE_RESULT_INFRARED_VALUE_OFFSET = 54;
    public static final int FULLNESS_SAMPLE_RESULT_INFRARED_HEALTH_OFFSET = 55;
    public static final int FULLNESS_SAMPLE_RESULT_MEASUREMENT_UID_OFFSET = 56;
    public static final int FULLNESS_SAMPLE_RESULT_MEASUREMENT_STATUS_OFFSET = 72;
    public static final int FULLNESS_SAMPLE_RESULT_STABLE_WEIGHT_VALID_OFFSET = 73;
    public static final int FULLNESS_SAMPLE_RESULT_STABLE_WEIGHT_GRAMS_OFFSET = 74;
    public static final int FULLNESS_SAMPLE_RESULT_LAST_OBSERVED_WEIGHT_VALID_OFFSET = 78;
    public static final int FULLNESS_SAMPLE_RESULT_LAST_OBSERVED_WEIGHT_GRAMS_OFFSET = 79;
    public static final int FULLNESS_SAMPLE_RESULT_MEASUREMENT_ELAPSED_MS_OFFSET = 83;
    public static final int FULLNESS_SAMPLE_RESULT_SAMPLE_COUNT_OFFSET = 87;
    public static final int FULLNESS_SAMPLE_RESULT_CALIBRATION_VERSION_OFFSET = 89;
    public static final int FULLNESS_SAMPLE_RESULT_WEIGHT_SENSOR_HEALTH_OFFSET = 93;
    public static final int FULLNESS_SAMPLE_RESULT_FAULT_CODE_OFFSET = 94;
    public static final int BASELINE_MEASUREMENT_RESULT_PAYLOAD_MIN_LENGTH = 93;
    public static final int BASELINE_MEASUREMENT_RESULT_PAYLOAD_MAX_LENGTH = 93;
    ...
    public static final int BASELINE_MEASUREMENT_RESULT_STABLE_WEIGHT_VALID_OFFSET = 70;
    public static final int BASELINE_MEASUREMENT_RESULT_STABLE_WEIGHT_GRAMS_OFFSET = 71;
    public static final int BASELINE_MEASUREMENT_RESULT_LAST_OBSERVED_WEIGHT_VALID_OFFSET = 75;
    public static final int BASELINE_MEASUREMENT_RESULT_LAST_OBSERVED_WEIGHT_GRAMS_OFFSET = 76;
    public static final int BASELINE_MEASUREMENT_RESULT_MEASUREMENT_ELAPSED_MS_OFFSET = 80;
    public static final int BASELINE_MEASUREMENT_RESULT_SAMPLE_COUNT_OFFSET = 84;
    public static final int BASELINE_MEASUREMENT_RESULT_CALIBRATION_VERSION_OFFSET = 86;
    public static final int BASELINE_MEASUREMENT_RESULT_WEIGHT_SENSOR_HEALTH_OFFSET = 90;
    public static final int BASELINE_MEASUREMENT_RESULT_FAULT_CODE_OFFSET = 91;
    ...
    public static final int SAFE_CLOSE_RESULT_PAYLOAD_MIN_LENGTH = 42;
    public static final int SAFE_CLOSE_RESULT_PAYLOAD_MAX_LENGTH = 42;
    ...
    public static final int SAFE_CLOSE_RESULT_DOOR_STATE_OFFSET = 38;
    public static final int SAFE_CLOSE_RESULT_DOOR_HEALTH_OFFSET = 39;
    public static final int SAFE_CLOSE_RESULT_FAULT_CODE_OFFSET = 40;
    public static final int CLEAN_COMPLETION_CONFIRMED_PAYLOAD_MIN_LENGTH = 60;
    public static final int CLEAN_COMPLETION_CONFIRMED_PAYLOAD_MAX_LENGTH = 60;
    ...
    public static final int CLEAN_COMPLETION_CONFIRMED_INFERRED_CLEAN_DOOR_STATE_OFFSET = 57;
    public static final int CLEAN_COMPLETION_CONFIRMED_CLEAN_DOOR_STATE_BASIS_OFFSET = 58;
    public static final int CLEAN_COMPLETION_CONFIRMED_CLEANER_PHYSICAL_CLOSE_CONFIRMED_OFFSET = 59;
    ...
    public static final int STATE_SNAPSHOT_PORT_PAYLOAD_MIN_LENGTH = 78;
    public static final int STATE_SNAPSHOT_PORT_PAYLOAD_MAX_LENGTH = 78;
    ...
    public static final int STATE_SNAPSHOT_PORT_DELIVERY_DOOR_STATE_OFFSET = 39;
    public static final int STATE_SNAPSHOT_PORT_DELIVERY_DOOR_HEALTH_OFFSET = 40;
    public static final int STATE_SNAPSHOT_PORT_CLEAN_LOCK_POWER_STATE_OFFSET = 41;
    public static final int STATE_SNAPSHOT_PORT_CLEAN_SOLENOID_HEALTH_OFFSET = 42;
    public static final int STATE_SNAPSHOT_PORT_INFERRED_CLEAN_DOOR_STATE_OFFSET = 43;
    ...
    public static final int STATE_SNAPSHOT_PORT_STABLE_WEIGHT_VALID_OFFSET = 47;
    public static final int STATE_SNAPSHOT_PORT_STABLE_WEIGHT_GRAMS_OFFSET = 48;
    public static final int STATE_SNAPSHOT_PORT_LAST_OBSERVED_WEIGHT_VALID_OFFSET = 52;
    public static final int STATE_SNAPSHOT_PORT_LAST_OBSERVED_WEIGHT_GRAMS_OFFSET = 53;
    ...
    public static final int STATE_SNAPSHOT_PORT_INFRARED_VALUE_OFFSET = 70;
    public static final int STATE_SNAPSHOT_PORT_INFRARED_HEALTH_OFFSET = 71;
    public static final int STATE_SNAPSHOT_PORT_SMOKE_STATE_OFFSET = 72;
    public static final int STATE_SNAPSHOT_PORT_SMOKE_SENSOR_HEALTH_OFFSET = 73;
    public static final int STATE_SNAPSHOT_PORT_FAULT_BITMAP_OFFSET = 74;
    ...
    public static Boolean ackRequired(int messageType) {
        return switch (messageType) {
            ...
            case MESSAGE_DELIVERY_DOOR_STATE_CHANGED -> true;
    ...
    public static Direction direction(int messageType) {
        return switch (messageType) {
            ...
            case MESSAGE_DELIVERY_DOOR_STATE_CHANGED -> Direction.MCU_TO_EDGE;
