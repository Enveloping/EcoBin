package org.enveloping.ecobin.funds.application.legacy;
...
import org.enveloping.ecobin.funds.infrastructure.persistence.mapper.WithdrawOrderMapper;
...
public class WalletServiceImpl
        implements WalletService, LegacyWalletCreditPort, LegacyFundsStatisticsPort {
    ...
    public void income(Long userId, Long tenantId, BigDecimal amount, Long deliveryOrderId) {
        ...
        credit(new LegacyOrganizationUserId(userId), tenantId, amount, deliveryOrderId);
    }
    ...
    public void credit(
        ...
        organizationUserFinancePort.addBalance(userId, amount);
    }
    ...
    @Override
    public LegacyFundsStatistics statistics() {
        return new LegacyFundsStatistics(
                withdrawOrderMapper.countAll(),
                withdrawOrderMapper.sumAmount(),
                withdrawOrderMapper.sumApprovedAmount());
    }
}
