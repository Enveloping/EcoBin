...
image=/var/lib/ecobin-image-factory/hil-v35-20260910-snapshot/candidate-single-card-hil-20260910-35/ecobin-orangepi-zero3-0.1.0-single-card.20260910.35.img
...
test_root=/var/lib/ecobin-image-factory/test-v35-20260910
state="$test_root/arm64-state"
mkdir -m 0700 "$state"
root="$(mktemp -d /var/lib/ecobin-image-factory/v35-smoke-root.XXXXXXXX)"
...
printf 'v35-arm64-smoke=PASS imageReadOnly=true networkIsolated=true syntheticStateOnly=true\n'
