...
repository=/var/lib/ecobin-image-factory/source-v36-20260910/repository
...
(umask 022; "$python" -m pytest -q -p no:cacheprovider -p v35_clock_fixture --basetemp /var/tmp/eb36-final)
printf 'v36-hardware-tests=PASS\n'
